...
#kernel to compute doppler factor
#need to do things like norm/dot explicitly
#therefore I separated x and y components
@cuda.jit(device=True)
def doppler_factor(v1, v2, r1, r2):
    #norms/dots v1, v2
    norm_v1_sq = v1[0]*v1[0] + v1[1]*v1[1]
    norm_v2_sq = v2[0]*v2[0] + v2[1]*v2[1]
    v2_dot_v1 = v2[0]*v1[0] + v2[1]*v1[1]
    norm_v1_minus_v2_sq = (v1[0]-v2[0])*(v1[0]-v2[0]) + (v1[1]-v2[1])*(v1[1]-v2[1])
    ...
    beta_norm_sq = beta_x*beta_x + beta_y*beta_y
 
    # np.dot(r2-r1)/(norm(r2-r1)**2)
    dr_x = r2[0] - r1[0]
    dr_y = r2[1] - r1[1]
    norm_dr = math.sqrt(dr_x*dr_x + dr_y*dr_y)
